...
export default function EditorPage() {
  ...
  // On the dedicated /editor/trash route, default to the Trash view so the
  // old editor workspace is never shown by mistake.
  const [activeView, setActiveView] = useState<"editor" | "trash">("trash");
